...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin">
        ...
        <spring:bind path="joiningDate">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="date" path="joiningDate" class="form-control" placeholder="Joining Date"
                            autofocus="true"></form:input>
        ...
        <spring:bind path="salary">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="number" path="salary" class="form-control" placeholder="Salary"
                            autofocus="true"></form:input>
