...
<html>
<head>
    <title>STH - Update Employee</title>
    <style>
        input[type=text] {
            width: 20%;
            padding: 12px 20px;
...
<div>
    <form:form action="/employee/update" method="post" modelAttribute="newEmployee">
        <p>
            <label>EmpID</label>
            <form:input type="number" path="empID" required="required"/>
        </p>
        <p>
